defmodule Mercato.HttpApiTest do
  ...
  describe "router macros" do
    test "mount all public, customer, admin, and referral routes" do
      expected_routes = [
        ...
        {"GET", "/api/products/product-id/variants", Mercato.Controllers.ProductController,
         :list_variants},
        ...
        {"GET", "/api/categories/category-id/products", Mercato.Controllers.CategoryController,
         :products},
        ...
        {"PUT", "/api/carts/cart-token/items/item-id", Mercato.Controllers.CartController,
         :update_item},
        {"DELETE", "/api/carts/cart-token/items/item-id", Mercato.Controllers.CartController,
         :remove_item},
        {"DELETE", "/api/carts/cart-token", Mercato.Controllers.CartController, :clear},
        {"POST", "/api/carts/cart-token/coupons", Mercato.Controllers.CartController,
         :apply_coupon},
        {"DELETE", "/api/carts/cart-token/coupons", Mercato.Controllers.CartController,
         :remove_coupon},
        ...
        {"PUT", "/api/orders/order-id/status", Mercato.Controllers.OrderController,
         :update_status},
        ...
        {"PUT", "/api/customers/profile", Mercato.Controllers.CustomerController,
         :update_profile},
        {"GET", "/api/customers/addresses", Mercato.Controllers.CustomerController,
         :list_addresses},
        {"POST", "/api/customers/addresses", Mercato.Controllers.CustomerController,
         :create_address},
        {"PUT", "/api/customers/addresses/address-id", Mercato.Controllers.CustomerController,
         :update_address},
        {"DELETE", "/api/customers/addresses/address-id", Mercato.Controllers.CustomerController,
         :delete_address},
        ...
        {"GET", "/api/subscriptions/subscription-id", Mercato.Controllers.SubscriptionController,
         :show},
        {"POST", "/api/subscriptions/subscription-id/pause",
         Mercato.Controllers.SubscriptionController, :pause},
        {"POST", "/api/subscriptions/subscription-id/resume",
         Mercato.Controllers.SubscriptionController, :resume},
        {"POST", "/api/subscriptions/subscription-id/cancel",
         Mercato.Controllers.SubscriptionController, :cancel},
  ...
  describe "referral routes" do
    ...
    test "POST /api/referrals/generate creates a referral code for the current user", %{
      conn: conn
    } do
      user_id = Ecto.UUID.generate()
